...
Follow this step-by-step workflow to turn your digital negatives created with this tool into archival cyanotype prints.
...
- **Digital Negative**: A calibrated inverted digital negative printed on transparent film at 300 DPI, prepared with our [Negative Creator](/).
...
- **Oxidation Aid (Optional)**: Standard 3% household Hydrogen Peroxide ($H_2O_2$).
...
Work under dim indoor tungsten or incandescent lighting, or in a room with blinds drawn. The sensitizer is insensitive to yellow/tungsten light, but **strictly avoid direct daylight, open windows, and fluorescent lamps with UV emission**.

1. Lay your paper on a clean, flat surface. You may lightly tape down the corners with low-tack masking tape.
2. Pour the required amount of freshly mixed working solution (approximately $1.5\text{–}2\text{ ml}$ for an A4 sheet) into a small beaker or directly onto the paper.
...
> [!TIP]
> Leaving a visible, uneven border of brush strokes around the edges adds an authentic, hand-crafted artistic signature characteristic of historic alternative prints.
...
4. **Important**: The paper must be **100% bone dry** before contact printing. Any residual moisture will transfer onto your transparency film, ruining both the negative and the print.
...
2. Lay your digital negative transparency **ink/emulsion side down** directly onto the coated paper surface. This emulsion-to-emulsion contact eliminates glass thickness refraction and guarantees razor-sharp details.
3. Place clean glass on top and clamp the edges securely with binder clips on all four sides. Firm, even pressure ensures crisp focus across the entire image.
...
> [!CAUTION]
> Avoid heavily chlorinated or alkaline tap water, which can prematurely bleach or degrade Prussian blue. If your tap water is hard or alkaline, add a tiny dash of citric acid or white vinegar to the initial rinse bath.
...
- Add a splash (approx. $5\text{–}10\text{ ml}$) of common **3% Hydrogen Peroxide ($H_2O_2$)** into a bath of clean water.
...
1. Immerse fully washed, dry cyanotype in a weak alkaline bath (0.5% $NaOH$ or $5\text{ g}$ washing soda per liter of water) for 10–30 seconds until the blue fades to pale yellow.
...
Ready to generate your calibrated digital negatives?  
Use our [Digital Negative Creator](/) to upload your photos, dial in curve adjustments, and export print-ready sheets!
